...
Plugin URI:  https://flexplat.com/wordpress-pwamp/
Description: WordPress PWAMP is a WordPress solution for both lightning fast load time of AMP pages and first load cache-enabled of PWA pages.
Version:     2.1.0
Author:      Rickey Gu
...
self.addEventListener(\'install\', function(event) {
	...
	private function transcode_page()
	{
		...
		$transcoding = new PWAMP_Transcoding($home_url, $data);
	...
	public function main()
	{
		...
		if ( is_plugin_active('pwampp/pwampp.php') || is_plugin_active('pwampo/pwampo.php') )
		{
			return;
		}
